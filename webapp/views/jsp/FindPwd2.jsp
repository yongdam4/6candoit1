...
<head>
  ...
  <link rel="stylesheet" href="../css/FindPwd2.css" />
</head>
  ...
  <div class="find-pwd">
    ...
    <div class="body">
      <div class="Change-Pwd-form">
        <div class="Change-Pwd-text">비밀번호 변경</div>
        <div class="mid">
          <div class="New-Pwd">
            <div class="New-Pwd-Blank">
              새 비밀번호
            </div>
            <input type="text" placeholder="새 비밀번호 입력칸" class="input-field">
          </div>
          <div class="New-Pwd-re">
            <div class="New-Pwd-Blank-re">
              새 비밀번호 재확인
            </div>
            <input type="text" placeholder="새 비밀번호 재확인" class="input-field">
          </div>
        </div>
