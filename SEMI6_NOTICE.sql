...
CREATE TABLE MEMBER( -- 회원 테이블 생성
    ...
    USER_AGE NUMBER CONSTRAINT USER_AGE_NN  NOT NULL, 
...
COMMENT ON COLUMN MEMBER.USER_AGE IS '회원나이';
...
-- �ӽ� ����������߰�
INSERT INTO MEMBER
VALUES ('admin', '1234', '������', 'F', 21, 'admin@kh.or.kr', '010-1111-2222', '2022-02-10', 'N', null, 'MASTER', '����� ������ ���ﵿ', '������', null);

INSERT INTO MEMBER
VALUES ('user01', 'pass01', 'ȫ�浿', 'F', 25, 'user01@kh.or.kr', '010-3333-2222', '2023-01-10', 'N', null, 'GOLD', '����� ��õ�� ��', null, 3);

INSERT INTO MEMBER
VALUES ('user02', 'pass02', '�谳��', 'M', 23, 'user02@kh.or.kr', '010-5555-7777', '2023-02-16', 'N', null, 'DIAMOND', '��⵵ ����� ���յ�', null, 5);
=======
-- 임시 멤버데이터추가
INSERT INTO MEMBER
VALUES ('admin', '1234', '관리자', 'F', 21, 'admin@kh.or.kr', '010-1111-2222', '2022-02-10', 'N', null, 'MASTER', '서울시 강남구 역삼동', '관리자', null);

INSERT INTO MEMBER
VALUES ('user01', 'pass01', '홍길동', 'F', 25, 'user01@kh.or.kr', '010-3333-2222', '2023-01-10', 'N', null, 'GOLD', '서울시 양천구 목동', null, 3);

INSERT INTO MEMBER
VALUES ('user02', 'pass02', '김개똥', 'M', 23, 'user02@kh.or.kr', '010-5555-7777', '2023-02-16', 'N', null, 'DIAMOND', '경기도 시흥시 정왕동', null, 5);
